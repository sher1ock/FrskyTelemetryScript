...
local function drawLeftPane(x,drawLib,conf,telemetry,status,battery,battId,getMaxValue,gpsStatuses)
  ...
  if telemetry.gpsLat ~= nil then
    lcd.drawText(70,8,telemetry.gpsLat,RIGHT+SMLSIZE)
    lcd.drawText(70,8+8,telemetry.gpsLon,RIGHT+SMLSIZE)
  end 
  -- alt asl/rng
  ...
  -- total distance
  lcd.drawText(115, 17, unitLongLabel, RIGHT+SMLSIZE)
  lcd.drawNumber(lcd.getLastLeftPos(), 17, telemetry.totalDist*unitLongScale*10, RIGHT+SMLSIZE+PREC1)  
