...
local function drawHud(drawLib,conf,telemetry,status,battery,getMaxValue)
  ...
  -------------------------------------
  -- black borders
  lcd.drawRectangle(32, 33 - 5, 19, 11, FORCE, 0)
  lcd.drawRectangle(32 + 64 -  17 - 3, 33 - 5, 20, 11, FORCE, 0)
  -- erase area
  lcd.drawFilledRectangle(32, 33 - 4, 18, 9, ERASE, 0)
  lcd.drawFilledRectangle(32 + 64 -  17 - 2, 33 - 4, 19, 9, ERASE, 0)
